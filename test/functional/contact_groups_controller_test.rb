...
class ContactGroupsControllerTest < ActionController::TestCase
  ...
  test "should create contact_group" do
    assert_difference('ContactGroup.count') do
      post :create, contact_group: { contact_group_description: @contact_group.contact_group_description, contact_group_name: @contact_group.contact_group_name, is_active: @contact_group.is_active }
    end
  ...
  test "should update contact_group" do
    put :update, id: @contact_group, contact_group: { contact_group_description: @contact_group.contact_group_description, contact_group_name: @contact_group.contact_group_name, is_active: @contact_group.is_active }
    assert_redirected_to contact_group_path(assigns(:contact_group))
  end
