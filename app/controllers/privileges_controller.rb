class PrivilegesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @privilege.save
        format.html { redirect_to privileges_path, notice: 'Privilege was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @privilege.update_attributes(params[:privilege])
        format.html { redirect_to privileges_path, notice: 'Privilege was successfully updated.' }
